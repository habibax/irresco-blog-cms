...
<div class="container-fluid ir_nopadding" >
    <header class="blog-header py-3 ir_header"  >
        <div class="row flex-nowrap justify-content-between align-items-lg-baseline" >
{{--            <div class="col-2 pt-1">--}}
{{--                <a class="link-secondary" href="#">نمیدونم چیچی</a>--}}
{{--            </div>--}}
            <div class="col-8 text-center">
                <a class="blog-header-logo text-dark ir_maintitle"  href="#"><span class="ir_textOutline">مرجع تخصصی کربن و گرافیت ایران</span></a>
            </div>
